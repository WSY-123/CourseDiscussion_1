"""
Django settings for CourseDiscussion project.
...
SECRET_KEY = 'e1^3)4fovmrboizzk%_hf81wm4ov9#b92dno^os1s(zjqb$!^r'
...
WSGI_APPLICATION = 'CourseDiscussion.wsgi.application'
